...
// Your task is to write a function that, given a list of words and a note, finds and returns the word in the list
//  that is scrambled inside the note, if any exists. If none exist, it returns the result ""-"" as a string.
//  There will be at most one matching word. The letters don't need to be in order or next to each other.
